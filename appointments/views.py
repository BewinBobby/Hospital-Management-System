...
from .forms import AppointmentBookingForm, DoctorEditForm, MedicalHistoryUpdateForm, PatientEditForm, PrescriptionForm, AppointmentForm, DoctorForm, PatientForm
